...
(function () {
  ...
  const REVIEWS = [{
    ...
    },
    {
      name: 'Mooen',
      rate: 5,
      text: '"The quality of the fabric is outstanding and the fit is exactly as described. Delivery took only two days — I\'ll definitely order again."'
    },
    {
      name: 'Olga R.',
      rate: 4,
      text: '"Отличный магазин: размерная сетка совпадает, вещи приходят аккуратно упакованными. Единственное — хотелось бы больше расцветок."'
    },
    {
      name: 'Karim D.',
      rate: 5,
      text: '"Customer support helped me exchange a size within a day. That kind of service is rare — this is now my default store for basics."'
    }
  ];
